...
<div class="article-content">
 ...
 <p class="text-gray-700">عدم وجود سوابق جنائية (شهادة حسن سيرة وسلوك من الجهات الرسمية)</p>
 </div>
 </div>
 ...
 <span class="text-gray-700"><strong>الشهادات الدراسية:</strong> (حسب المهنة) ثانوية عامة، دبلوم، بكالوريوس <span class="text-xs text-gray-500">(كشف العلامات غير إجباري)</span></span>
 </li>
 <li class="flex items-start gap-3">
 <i class="fas fa-check-circle text-blue-600 mt-1"></i>
 ...
 <span class="text-gray-700"><strong>شهادة حسن سيرة وسلوك:</strong> (حسن سيرة وسلوك) من دائرة الأمن العام الأردنية</span>
 </li>
 <li class="flex items-start gap-3">
 <i class="fas fa-check-circle text-green-600 mt-1"></i>
 ...
 <h3 class="text-2xl font-bold text-navy">الاعتماد المهني (QVP)</h3>
 </div>
 <p class="text-gray-700 mb-3">
 ...
 <tr class="border-b border-gray-200">
 <td class="py-3">الاعتماد المهني (QVP)</td>
 <td class="py-3 font-semibold">30 - 50 دينار</td>
 </tr>
 <tr class="border-b border-gray-200">
 <td class="py-3">شهادة حسن سيرة وسلوك</td>
 ...
 <li class="flex items-center gap-2">
 <i class="fas fa-check text-blue-600"></i>
 <span>إتمام الاعتماد المهني (QVP)</span>
 </li>
 </ul>
 ...
 <span class="text-gray-700 font-semibold">الاعتماد المهني (QVP)</span>
 </div>
 ...
 <details class="bg-white rounded-lg shadow-md overflow-hidden">
 <summary class="px-6 py-4 cursor-pointer font-bold text-navy hover:bg-gray-50 transition-colors flex items-center justify-between">
 <span>هل أحتاج فعلاً إلى الاعتماد المهني (QVP)؟</span>
 <i class="fas fa-chevron-down text-gold"></i>
 </summary>
 <div class="px-6 py-4 text-gray-700 border-t border-gray-100">
...
<div class="article-content">
 ...
 <li class="flex items-start gap-3">
 <i class="fas fa-check-circle text-blue-600 mt-1"></i>
 <span><strong>الشهادات الجامعية:</strong> بكالوريوس، ماجستير، دكتوراه <span class="text-xs text-gray-500">(كشف العلامات غير إجباري)</span></span>
 </li>
 <li class="flex items-start gap-3">
 <i class="fas fa-check-circle text-blue-600 mt-1"></i>
 ...
 <li class="flex items-start gap-3">
 <i class="fas fa-check-circle text-blue-600 mt-1"></i>
 <span><strong>الثانوية العامة:</strong> شهادة التوجيهي <span class="text-xs text-gray-500">(كشف العلامات غير إجباري)</span></span>
 </li>
 <li class="flex items-start gap-3">
 <i class="fas fa-check-circle text-blue-600 mt-1"></i>
 ...
 <li class="flex items-start gap-3">
 <i class="fas fa-check-circle text-purple-600 mt-1"></i>
 <span><strong>شهادة حسن سيرة وسلوك:</strong> (حسن سيرة وسلوك)</span>
 </li>
 <li class="flex items-start gap-3">
 <i class="fas fa-check-circle text-purple-600 mt-1"></i>
 ...
 <strong>ملاحظة مهمة:</strong> كشف العلامات <strong class="text-blue-700">غير إجباري</strong> للتصديق — المطلوب فقط الشهادة الأصلية.
 </p>
 </div>
 </div>
 ...
 <p class="text-green-600 text-sm">أحوال مدنية، خبرة، وكالات، شهادة حسن سيرة وسلوك، إلخ</p>
 </div>
 </div>
...
<div class="article-content">
 ...
 <h3 class="text-2xl font-bold text-navy">عدم تصديق جميع الوثائق المطلوبة</h3>
 </div>
 <div class="bg-red-50 p-6 rounded-lg mb-4">
 <h4 class="font-bold text-red-700 mb-2">الخطأ:</h4>
 <p class="text-gray-700">
 البعض يصدّق الشهادة الجامعية فقط وينسى وثائق أخرى قد تكون مطلوبة لمهنته (مثل شهادات الخبرة إن كانت متوفرة). <span class="text-gray-500 text-sm block mt-2"><i class="fas fa-info-circle text-gold"></i> ملاحظة: <strong>كشف العلامات غير إجباري</strong> للتصديق — المطلوب فقط الشهادة الأصلية وشهادات الخبرة.</span>
 </p>
 </div>
 ...
 <h3 class="text-2xl font-bold text-navy">عدم إجراء الاعتماد المهني (QVP)</h3>
 </div>
